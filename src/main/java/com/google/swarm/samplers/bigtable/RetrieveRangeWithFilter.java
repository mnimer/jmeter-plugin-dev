...
public class RetrieveRangeWithFilter extends BigtableSamplerClient implements Serializable {
    ...
    public Arguments getDefaultParameters()
    {
        ...
        defaultParameters.addArgument("filterColumn2Value", "");
    ...
    public SampleResult runTest(JavaSamplerContext context)
    {
        ...
        String filterColumn2Value = context.getParameter("filterColumn2Value");
        ...
        String data = "RowKeyStart: " + rowkeyStart + " RowKeyEnd: " + rowkeyEnd + " Columns " + columns +
                ...
                " FilterCol2Name/Value: " + filterColumn2Name + "/" + filterColumn2Value;
...
//            throwExceptionIfMissing(columns, "columns");
            ...
            try (Table dbTable = getConnection().getTable(TableName.valueOf(table)))
            {
                ...
                Filter filter = buildFilter( columnFamilyName, filterColumn1Name, filterColumn1Value, filterColumn2Name, filterColumn2Value);
